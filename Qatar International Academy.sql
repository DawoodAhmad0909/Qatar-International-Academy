...
WHERE c.class_id=1; -- by changing class_id you can find data for any class
...
WHERE 
    ...
    -- changing dates you can find data for any week
GROUP BY date
ORDER BY date;
...
WHERE 
	st.staff_id=3
	-- changing id you can find data for any teacher
